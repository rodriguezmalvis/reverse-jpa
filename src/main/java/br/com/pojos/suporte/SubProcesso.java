...
public class SubProcesso implements java.io.Serializable {
	...
	public SubProcesso(SubProcessoId id, Date dthrApresentacao, Date mesAnoVigencia, boolean FIntegralmenteNegado,
			boolean FReembolsoSegueCronograma, boolean FPagamentoBloqueado, Date timestamp) {
		this.id = id;
	...
	public SubProcesso(SubProcessoId id, Prestador prestador, SubProcesso subProcesso, Date dthrApresentacao,
			...
			Date timestamp, String amApres, Integer codRepr, Integer numProc, Integer seqProc, Date dthrDesbloqueio,
			String numeroLote, Date dtRecebimentoLote, Integer idProtocolo, Set<Atendimento> atendimentos,
