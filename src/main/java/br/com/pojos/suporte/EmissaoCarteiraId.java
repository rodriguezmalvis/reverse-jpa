...
/**
 * EmissaoCarteiraId generated by hbm2java
 */
@Embeddable
public class EmissaoCarteiraId implements java.io.Serializable {

	private long numeroCarteira;
	private byte dv;

	public EmissaoCarteiraId() {
	}

	public EmissaoCarteiraId(long numeroCarteira, byte dv) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EmissaoCarteiraId))
			return false;
		EmissaoCarteiraId castOther = (EmissaoCarteiraId) other;
